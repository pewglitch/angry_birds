...
public class white extends InputMultiplexer
{
    ...
    private static final float Mdd = 1.5f;
    private static final float Lf = 20.0f;
    ...
    public white(World world, TextureRegion texture, float x, float y, Stage stag)
    {
        this.world = world;
